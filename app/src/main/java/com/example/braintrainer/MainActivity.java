    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer timer = new CountDownTimer(20000, 100) {
            ...
            public void onTick(long l) {
                ...
                if (l < 10000) {
                    textViewTimer.setTextColor(getResources().getColor(android.R.color.holo_red_light,getTheme()));
                }
            }
...
//                gameOver = true;
    ...
    private String getTime(long l) {
        ...
        seconds = seconds % 60;
        String result = String.format(Locale.getDefault(), "%02d:%02d", minutes, seconds);
        return result;
    }
    ...
    public void onClickAnswer(View view) {
        if (!gameOver) {
            ...
            int answerChoosen = Integer.parseInt(answer);
            if (answerChoosen == rightAnswer) {
                countOfRightAnswer++;
